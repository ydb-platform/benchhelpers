...
) PARTITION BY HASH(C_W_ID) PARTITIONS 50;
...
) PARTITION BY HASH(H_C_W_ID) PARTITIONS 50;
...
CREATE TABLE ITEM (
  ...
  PRIMARY KEY (I_ID)
) PARTITION BY HASH(I_ID) PARTITIONS 50;
...
) PARTITION BY HASH(NO_W_ID) PARTITIONS 50;
...
) PARTITION BY HASH(O_W_ID) PARTITIONS 50;
...
) PARTITION BY HASH(OL_W_ID) PARTITIONS 50;
...
) PARTITION BY HASH(S_W_ID) PARTITIONS 50;
